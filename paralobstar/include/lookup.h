//
// Created by Johannes Martin on 14.10.21.
//

#ifndef PARALOBSTAR_LOOKUP_H
#define PARALOBSTAR_LOOKUP_H
...
namespace lookup {
    ...
    const unsigned char VectorProduct[3][2] = { {1,2}, {2,0}, {0,1} };
}

#endif //PARALOBSTAR_LOOKUP_H
